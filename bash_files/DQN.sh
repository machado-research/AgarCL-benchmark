...
#SBATCH --job-name=DQN_Exp_3_noise
#SBATCH --output=DQN_Exp_3_noise.out
#SBATCH --error=DQN_Exp_3_noise.err
#SBATCH --ntasks=1
...
module load python/3.10.13 #Noise
...
python DQN_full_action_set.py --seed $seed --outdir "/home/mayman/Results/DQN_mode_2"